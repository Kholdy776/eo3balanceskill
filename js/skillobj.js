...
const p_name = ["Blank","Attack","HP Up","TP Up","Bandage","Combat Study","Chop","Mine","Take","Royal Veil","Monarch March","Royal Lineage","Triumphant Cry","Reinforce","Nobility Proof","Attack Order","Guard Order","Elemental Bomb","Negotiation","Inspire","Ad Nihilo","Fire Arms","Freeze Arms","Shock Arms","Regal Radiance","Prevent Order","Protect Order","Knighthood","Endless Battle","Sword Mastery","Club Mastery","Avenger","Stun Attack","Wild Swings","Iron Will","Berserker Vow","Wolf Howl","Grand Colosseum","Break","Rush","Bind Cut","Bloodthirst","Blade Rave","Crushing Blow","Arm Breaker","Freezing Blow","Nine Smashes","Guardian","Spear Mastery","Shield Mastery","Parry","Rhongomyniad","Rex Hasta","Exploit Weakness","Provoke","Shrug Off","Gáe Bolg","Gungnir","Geirskögul","Aegis","Hoplon","Phalanx","Gradivus","Bodyguard","Overwatch","Vigilance","Trickster","Rapier Mastery","Gun Mastery","Swashbuckling","Lady Luck","Limit Boost","Eagle Eye","Quick Draw","Rapid Fire","Chase Flame","Chase Ice","Chase Volt","Lights Out","Hanging","Chase Saber","Chase Blow","Chase Thrust","Pincushion","Double Tap","Mystic Calm","Beheading","Katon","Reflexes","Hyouton","Knife Mastery","Raiton","Otori","Ninpo: Smoke","Ninpo: Double","Seiton Tenchu","Ninpo: Needles","Ninjutsu","Ninpo: Shuriken","Shadow Bind","Hawk Strike","Izuna","Chimatsuri","Genjutsu","Form Qi","Fist Mastery","Ascetic Deeds","Full Cleansing","Blood Return","Sanctify","Kikouken","Healing","Party Heal","Full Heal","Counter","Retaliate","Merciful Heal","Resurrect","Aura Blast","Line Heal","Breakfire Fist","Darkness Fist","Levitate","Etheric Return","Inferno","Cocytus","Thor","Ether Mastery","Singularity","Etheric Charge","Dark Ether","Meteor","Fire Star","Binary Fire","Prominence","Ice Star","Binary Ice","Deluge","Volt Star","Binary Thunder","Tempest","Supernova","Nature Pact","Wild Mastery","Beast Soul","Sacrifice","Spirit Fang","Primal Energy","Beast Roar","Primal Drums","Dismiss Beast","Call Bird","Call Snake","Call Mole","Call Slime","Call Cow","Call Owl","Call Pasaran","Call Tiger","Call Lion","Call Ooze","Giant Kill","Bolt Mastery","Extend","Night Vision","Multi-Shot","Proper Form","Sagittarius Arrow","Smoke Grenade","Apollo's Wrath","Heavy Shot","Artemis' Embrace","Eros' Carnage","Armor Piercer","Fire Barrage","Front Mortar","Ice Barrage","Volt Barrage","Cloudbuster","Ambush","Earth's Bounty","Death Blight","Contagion","Camp Mastery","Witchcraft","Keen Nose","Devil's Candle","Dust Devil","Rotten Egg","Lullaby","Strange Seeds","Offering","Harvest Time!","Malediction","Safe Stroll","Devil's Snare","Thorn Bind","Mesmerize","Harvestry","Second Sword","Katana Mastery","Endure","Upper Stance","Bloody Lance","Morale Boost","Middle Stance","Hilt Strike","Morning Star","Twilight Hour","5-Ring Sword","Great Warrior","Warrior Might","Fore Honor","Rear Dignity","Ambush Stance","Alertness","Blitz Command","Lower Stance","Sleep Mode","Overheat","Bastion","Annihilation Protocol","Infravision","Data Mining","Benben","Perkins","Pascal","Fortification","Reflector","Family's Warmth","All Out","Rocket Punch   ","Rocket Head    ","Rocket Jump","HP Cannon","Core Dump","Defrag","Cross Slash","Indomitable","Charge Tactic","Mumyouken","Guard Tactic","Second Wind","Regroup Tactic","Aegis Defense","Hellfire","Lucky Hammer","Absolute Zero","Aegis Barrier","Tri-Magic","Superspeed","Typhoon Bolt","Aegis Shield","Chain Blast","Star Smasher","Wind Tactic","Uroboros Guard","Immortal","Buc Farm","Buc Nin","Buc Mon","Buc Farm","Nin Prin","Nin Glad","Nin Farm","Nin Do","Nin Farm","Bind Feather","Wind Wrap","Scratch","Slime Protection","Bull Run","Sleep Powder","Self-Destruct","Death Fang","Regal Authority","Ooze Protection","Bind Feather","Wind Wrap","Scratch","Slime Protection","Bull Run","Sleep Powder","Self-Destruct","Fierce Counter","Regal Authority","Ooze Protection","NONE","NONE","NONE","NONE","Ooze Protection","Ooze Protection","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","NONE","Fusillade","Blitz Command","NONE","Reflector","Artemis' Embrace","Kaishaku","Ice All","Volt All","NONE","Zod Nin","Zod Aba","Buc Nin","Buc Farm","Nin Prin","Apollo's Wrath","Eros' Carnage","IMPORTANT","IMPORTANT","NONE","NONE","NONE","Defend","Escape","NONE","Medica Type","Amrita Type","Hamao Type","Nectar Type","Nectar Type","Soma Type","Theriaca A","Theriaca A","Theriaca B","Theriaca B","Sanctify","Bombardment","SUMMON?","Discharge","Protect Order","NONE","Strange Seed","Tiger Counter","Warrior Might","Cloudbuster","Counter","Retaliate","Chase Saber","Chase Blow","Chase Thrust","Chase Flame","Chase Ice","Chase Volt","Parry Heal","Ambush Stance","Rocket Punch   ","Rocket Head    ","Rocket Jump","Benben","Perkins","Pascal","Fire All","Infect","Restore Mark","Fire Prophecy","Ice Prophecy","Volt Prophecy","Last Chase","Metapon","Unihorn","Bravant","Clairvoyant","Fire Mist","Ice Mist","Volt Mist","Cut Mist","Bash Mist","Stab Mist","Blaze Oil","Freeze Oil","Shock Oil","Fire Jar","Flame Jar","Ice Jar","Frost Jar","Volt Jar","Storm Jar","Poison Gas","Stun Gas","Blind Gas","Sleep Gas","Curse Gas","Addle Gas"]
